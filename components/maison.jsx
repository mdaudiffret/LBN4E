  ...
  return (
    React.createElement("section", null,
      ...
      React.createElement("div", {
        ...
        [
          "Vingt codes scellent ces pages — chacun estant un mot. Pour chacun d'iceux, trois indices ont esté cachés en la Gazette — du plus ardu au plus clément — soit soixante dépêches en tout, publiées chaque vendredi à XII heures sonnantes.",
          "Chaque indice vous révèle la position du code parmy les vingt, & quelque indice sur le mot qu'il vous faut trouver. Point n'est besoin d'attendre le dernier : si le premier vous illumine l'esprit, saisissez le mot sans délai.",
